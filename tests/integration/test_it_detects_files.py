...
@pytest.mark.parametrize('name,node_type,mimetype,extension,num_children', [
    ('basic.csv', fables.Csv, 'text/plain', 'csv', 0),
    ('basic.xlsx', fables.Xlsx, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'xlsx', 0),  # noqa: E501
...
@pytest.mark.parametrize('name,expected_to_be_encrypted', [
    ('basic.csv', False),
    ('encrypted.zip', True),
    ('basic.zip', False),
    ('encrypted.xlsx', True),
